...
const (
	...
	EndpointGetApplicationActivityInstance                 = "applications/{application.id}/activity-instances/{instance.id}"
	...
	EndpointListApplicationEmojis                          = "applications/{application.id}/emojis"
	EndpointGetApplicationEmoji                            = "applications/{application.id}/emojis/{emoji.id}"
	EndpointCreateApplicationEmoji                         = "applications/{application.id}/emojis"
	EndpointModifyApplicationEmoji                         = "applications/{application.id}/emojis/{emoji.id}"
	EndpointDeleteApplicationEmoji                         = "applications/{application.id}/emojis/{emoji.id}"
	EndpointListEntitlements                               = "applications/{application.id}/entitlements"
	EndpointGetEntitlement                                 = "applications/{application.id}/entitlements/{entitlement.id}"
	EndpointConsumeEntitlement                             = "applications/{application.id}/entitlements/{entitlement.id}/consume"
	EndpointCreateTestEntitlement                          = "applications/{application.id}/entitlements"
	EndpointDeleteTestEntitlement                          = "applications/{application.id}/entitlements/{entitlement.id}"
	...
	EndpointGetGuildRole                                   = "guilds/{guild.id}/roles/{role.id}"
	...
	EndpointGetAnswerVoters                                = "channels/{channel.id}/polls/{message.id}/answers/{answer.id}"
	EndpointEndPoll                                        = "channels/{channel.id}/polls/{message.id}/expire"
	EndpointListSKUs                                       = "applications/{application.id}/skus"
	EndpointSendSoundboardSound                            = "channels/{channel.id}/send-soundboard-sound"
	EndpointListDefaultSoundboardSounds                    = "soundboard-default-sounds"
	EndpointListGuildSoundboardSounds                      = "guilds/{guild.id}/soundboard-sounds"
	EndpointGetGuildSoundboardSound                        = "guilds/{guild.id}/soundboard-sounds/{sound.id}"
	EndpointCreateGuildSoundboardSound                     = "guilds/{guild.id}/soundboard-sounds"
	EndpointModifyGuildSoundboardSound                     = "guilds/{guild.id}/soundboard-sounds/{sound.id}"
	EndpointDeleteGuildSoundboardSound                     = "guilds/{guild.id}/soundboard-sounds/{sound.id}"
	...
	EndpointListSKUSubscriptions                           = "skus/{sku.id}/subscriptions"
	EndpointGetSKUSubscription                             = "skus/{sku.id}/subscriptions/{subscription.id}"
	...
	EndpointGetCurrentUserApplicationRoleConnection        = "users/@me/applications/{application.id}/role-connection"
	EndpointUpdateCurrentUserApplicationRoleConnection     = "users/@me/applications/{application.id}/role-connection"
...
const (
	...
	CDNEndpointStorePageAsset           = "app-assets/application.id/store/asset.id"
...
// https://discord.com/developers/docs/reference#signed-attachment-cdn-urls-attachment-cdn-url-parameters
const (
	CDNURLParameterExpire    = "ex"
	CDNURLParameterIssued    = "is"
	CDNURLParameterSignature = "hm"
)
